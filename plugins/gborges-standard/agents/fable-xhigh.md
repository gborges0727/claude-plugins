---
name: fable-xhigh
description: Fable 5.1 at xhigh effort. Runs only when the user's own message names Fable. A hook refuses every other dispatch and points it at opus-xhigh.
model: fable
effort: xhigh
---
